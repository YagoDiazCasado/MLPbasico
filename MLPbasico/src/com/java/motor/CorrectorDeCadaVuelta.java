...
public class CorrectorDeCadaVuelta { // Este tio empieza la ronda de correcciones cuando la red ha dado una vuelta
	...
	public static double calcularPerdida(double[] loQueTeniaQueSalir, double[] loQueHaSalido) {
		double suma = 0;
	...
	public static double[] gradienteRespectoAlIntento(double[] loQueTeniaQueSalir, double[] loQueHaSalido) {
